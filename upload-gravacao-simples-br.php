...
<form name="gravacoes" action="http://vem.vento-consulting.com/upload-gravacao-simples.php?id=<?php echo $_GET["id"]; ?>" enctype="multipart/form-data" method="post">
