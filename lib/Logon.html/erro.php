...
<div id="intall-box" style=" padding:10px; text-align:center; border:#7F7F7F 1px solid; position: relative; height:300px; background-color:#FFFFFF; width:700px; margin-left:auto; margin-right:auto; top:50%; margin-top:-300px;">
	<img src="img/erro.png" alt="Erro ao instalar passaporte." style="width:100px; margin-top:20px;" />
	<h3 style="color:#A52A2A;">Não foi possível efetuar o login no sistema.</h3>
	<br />
	<span style="font-size:13px;">
	Você excedeu o número máximo de logins silmultâneos permitidos no sistema.
	</span>
	<br />
	<br />
	<br />
	<input type="button" onclick="javascript:self.location='index.php';" value="Voltar " style=" border: 1px solid #7F7F7F; cursor:pointer;" />
</div>
